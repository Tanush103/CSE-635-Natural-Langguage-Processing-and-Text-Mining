...
class LSTM(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_dim, output_dim, n_layers, 
        ...
        self.lstm_layer=nn.LSTM(embedding_dim,hidden_dim,n_layers,dropout=dropout,bidirectional=bidirectional)
    ...
    def forward(self, text, text_lengths):
        ...
        output_layer,(hidden_layer,cell_layer) =self.lstm_layer(embedded_layer)
